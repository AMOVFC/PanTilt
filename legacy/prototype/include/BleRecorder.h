...
// and separately exposes a resync (see main.cpp for how short vs. long
// press on the slide encoder's push button maps to these).
//
// Unchanged from the final rig's BleRecorder — pure software, no wiring
// dependency at all.
