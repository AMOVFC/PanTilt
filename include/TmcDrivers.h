#pragma once
// UART configuration plane for the four TMC2209s. Motion stays on STEP/DIR
// via FastAccelStepper — UART is used at boot to set current and
// microstepping in firmware (replacing the trimpot/jumper approach), verify
// each driver actually responds, and confirm the microstep register took.
// Same config/motion split Marlin uses for TMC drivers.

#include <cstdint>

namespace tmc_drivers {

// Initializes the shared half-duplex UART bus and configures all 4 drivers:
