...
//
// Unchanged from the final rig's WebConfig — entirely descriptor-driven,
// no axis-count-specific logic.
//
...
// being served briefly blocks the main loop.
...
// returns true; reads stay available. The prototype has no ShotSequencer
// yet, so main.cpp passes a callback that always returns false.
