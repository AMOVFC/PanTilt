...
namespace {
Preferences prefs;
// Distinct namespace from the final rig's "sliderCfg" — the two firmwares'
// settings aren't compatible (different row set), and a chip that's run
// both builds shouldn't have one overwrite the other's saved values.
constexpr const char *kNvsNamespace = "protoCfg";
}  // namespace
